...
class ReinburstController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('marketing.reinburst.index', compact('reinbursts'));
    }
            ...
            ->editColumn('action', function ($data) {
               ...
               $reinburst = Reinburst::where('id', $data->id)->where('status_hrd', 'pending')->get();
                if (count($reinburst)==0){
                   return '<a href="' . route('marketing.reinburst.pdf', $data->id) . '"class="btn btn-sm btn-secondary"><i class="fa-solid fa-print"></i></a>';
                }else {
                 return '<a href="' . route('marketing.reinburst.pdf', $data->id) . '"class="btn btn-sm btn-secondary"><i class="fa-solid fa-print"></i></a>
                <a href="' . route('marketing.reinburst.edit', $data->id) . '" class="btn btn-sm btn-info"><i class="fa fa-edit"></i></a>
                <a href="' .  route('marketing.reinburst.destroy', $data->id). '" class="delete-form btn btn-sm btn-danger"><i class="fa fa-trash"></i></a>';
    ...
    public function create()
    {
        ...
        return view('marketing.reinburst.create', compact('projects', 'nourut'));
    }
    ...
    public function store(Request $request)
    {
        ...
        DB::commit();
        return redirect()->route('marketing.reinburst.index')->with('success', 'Reinburst has been added');
    }
    ...
    public function show(Reinburst $reinburst)
    {
        ...
        return view('marketing.reinburst.show', compact('reinbursts', 'rincianreinbursts', 'reinburst'));
    }
    ...
    public function edit(Reinburst $reinburst)
    {
        ...
        return view('marketing.reinburst.edit', compact('reinburst', 'reinbursts', 'peng', 'projects'));
    }
    ...
    public function update(Request $request, Reinburst $reinburst)
    {
        ...
        return redirect()->route('marketing.reinburst.index')->with('success', 'Reinburst has been updated');
    }
    ...
    public function pdf($id)
    {
        ...
        // dd($reinbursts);
        // $rincianreinbursts = RincianReinburst::where('nomor_reinburst', $reinburst->nomor_reinburst)->get();
        return view('marketing.reinburst.pdf', compact('reinbursts'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('marketing.reinburst.index')->with('success', 'Reinburst has been deleted');
    }
}
