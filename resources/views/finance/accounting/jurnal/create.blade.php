@extends('layouts.master', ['title' => 'Create Jurnal Voucher'])

@section('content')
<div class="row">
    <div class="col-md-4">
        <h1 class="page-title">Create Jurnal Voucher</h1>
    </div>
</div>
                        ...
                        <div class="col-lg-3">
                            {{-- <h6>Total due</h6> --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="sub_total1" name="total" required readonly class="form-control">
                                    </div>
                        ...
                        <div class="col-lg-3">
                            {{-- <h6>Total due</h6> --}}
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" id="sub_total" name="totals" required readonly class="form-control">
                                    </div>
