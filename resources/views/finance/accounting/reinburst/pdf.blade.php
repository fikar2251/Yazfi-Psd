                            ...
                            <table cellspacing="5" cellpadding="5">
                                ...
                                <tbody style="font-size: 16px; 	font-family: 'Rubik', sans-serif;">
                                    ...
                                    <tr>
                                        <td>Tanggal</td>
                                        <td>:</td>
                                        <td>{{ Carbon\Carbon::parse($reinbursts->tanggal_reinburst)->isoFormat('dddd, D MMMM Y') }}
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>Lampiran</td>
                                        <td>:</td>
                                        <td>{{$reinbursts->nomor_reinburst}}/{{ $reinbursts->file }}</td>
                                    </tr>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered  ">
                                <tr class="bg-success" style="font-size:12px; text-align:center;" >
                                    <th style="width:10%; text-align:left;" class="text-light">No.</th>
