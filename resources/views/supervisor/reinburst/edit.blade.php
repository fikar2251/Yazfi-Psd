@extends('layouts.master', ['title' => 'Edit Reinburst'])
@section('content')
    ...
    <div class="col-md-12">
        <div class="card shadow" id="card">
            <div class="card-body">
                ...
                <form action="{{ route('supervisor.reinburst.update', $reinburst->id) }}" method="post" enctype="multipart/form-data">
                    @method('PATCH')
                    @csrf
                    <div class="row">
                        <div class="col-sm-6 col-sg-4 m-b-4">
                            <ul class="list-unstyled">
                                <li>
                                    <div class="form-group">
                                        ...
                                        <input required="" type="text" name="nomor_reinburst" value="{{$reinburst->nomor_reinburst ?? '' }}" id="nomor_reinburst" class="form-control" readonly>
                                    </div>
                                </li>
                            </ul>
                        </div>
                            ...
                            <ul class="list-unstyled">
                                <li>
                                    <div class="form-group">
                                        ...
                                        <input type="date" name="tanggal_reinburst" id="tanggal_reinburst" value="{{Carbon\Carbon::parse($reinburst->tanggal_reinburst)->format('Y-m-d')}}" class=" form-control">
                                    </div>
                                </li>
                            </ul>
                        </div>
                                ...
                                <table class="table table-hover border" id="table-show">
                                    ...
                                    <tbody id="dynamic_field">
                                        ...
                                        <tr class="rowComponent">
                                            <td hidden>
                                                <input type="hidden" name="no_kwitansi[{{ $loop->iteration }}]" class="no_kwitansi-{{ $loop->iteration }}">
                                            </td>
                                            <td>
