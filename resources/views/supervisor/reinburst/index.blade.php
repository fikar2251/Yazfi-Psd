...
<div class="row">
    ...
    <div class="col-sm-8 text-right m-b-20">
        <a href="{{ route('supervisor.reinburst.create') }}" class="btn btn btn-primary btn-rounded float-right"><i
            ...
            <table class="table  table-striped custom-table report" id="reinburst" width="100%">
                <thead>
                    <tr style="text-align:center">
                        ...
                        <th style="width:5%; text-align:right;">Total Pembelian</th>
    ...
    $(document).ready(function () {
        ...
        function load_data(from = '', to = '') {
            ...
            var table = $('#reinburst').DataTable({
                ...
                ajax: {
                    url: '/supervisor/ajax/ajax_reinburst',
                    get: 'get',
                    data: {
                        from: from,
                        to: to
